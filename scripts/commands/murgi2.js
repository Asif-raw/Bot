...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("আসিফবস খালি বলেন কাকে চুদতে চান এমন 1 জনকে @ম্যানশন করতে হবে", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("চুদা লো");
setTimeout(() => {a({body: "তোর মাকে গরুর সাথে সহবাস করাবো, এরপর তোর মা গরুর সাথে সংসার কর।" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "খাংকির হিন্দু ধর্মের গুরুরা তর মারে পুজো করার লোভ দেখিয়ে চুদে.." + " " + name, mentions: arraytag})}, 5000);
setTimeout(() => {a({body: "মাদারচোদ তর আম্মু পম পম খাংকির পো 🐰" + " " + name, mentions: arraytag})}, 7000);
setTimeout(() => {a({body: "Tor Bapp Asif খাংকির পোলা তর কচি ভুদায় ভুদায় কামর দিমু  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a({body: "আমি তোর বাপ আফিসফফফ উফফফ খাদ্দামা মাগির পোলা তর আম্মুর কালা ভুদায় আমার মাল আউট তর কচি বোন রে উপ্তা করে এবার চুদবো  💉।" + " " + name, mentions: arraytag})}, 25000);
...
setTimeout(() => {a({body: "আসিব তোর বাপ তর কচি বোন এর পম পম😍.." + " " + name, mentions: arraytag})}, 105000);
...
setTimeout(() => {a({body: "Hi কুত্তার এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
